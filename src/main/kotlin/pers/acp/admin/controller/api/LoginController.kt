...
import pers.acp.admin.vo.OnlineInfoVo
...
constructor(
    ...
    fun doLogOut(@ApiIgnore user: OAuth2Authentication): ResponseEntity<InfoVo> =
        try {
    ...
    @Throws(ServerException::class)
    fun getOnlineInfo(@ApiIgnore user: OAuth2Authentication): ResponseEntity<List<OnlineInfoVo>> =
        try {
